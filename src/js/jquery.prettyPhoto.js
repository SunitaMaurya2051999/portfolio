...
!function(e) {
    ...
    e.fn.prettyPhoto = function(a) {
        ...
        e.prettyPhoto.open = function(t) {
            ...
            $pp_pic_holder.find(".currentTextHolder").text(set_position + 1 + settings.counter_separator_label + e(pp_images).length),
            ...
            $pp_pic_holder.fadeIn(function() {
                ...
                case "image":
                    ...
                    nextImage = new Image,
                    isSet && set_position < e(pp_images).length - 1 && (nextImage.src = pp_images[set_position + 1]),
                    prevImage = new Image,
        ...
        e.prettyPhoto.changePage = function(t) {
            ...
            set_position < 0 && (set_position = e(pp_images).length - 1)) : "next" == t ? (set_position++,
            set_position > e(pp_images).length - 1 && (set_position = 0)) : set_position = t,
